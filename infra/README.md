# FND QuickLaunch - Docker Infrastructure
...
DATABASE_URL=postgresql://fnd_user:fnd_pass@localhost:5432/fnd_quicklaunch
...
2. Add Redis Database:
   ...
   - Port: 6379
   - Database Alias: FND QuickLaunch

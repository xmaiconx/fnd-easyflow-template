...
echo "========================================"
echo "STATUS: SUCCESS"
echo "HOTFIX_ID: F${NEXT_NUMBER}-${HOTFIX_NAME}"
echo "BRANCH_NAME: ${NEW_BRANCH_NAME}"
echo "BRANCH_TYPE: fix"
echo "HOTFIX_PATH: ${HOTFIX_PATH}"
echo "PRIORITY: HIGH"
echo ""
echo "FILES_CREATED:"
echo "  - ${HOTFIX_PATH}/about.md"
echo ""
echo "SECTIONS_TO_FILL:"
echo "  - Problem Description: What is happening, Expected behavior, Impact"
echo "  - Investigation: Steps to reproduce, Error messages, Root cause"
echo "  - Solution: Approach, Files to modify, Changes made"
echo "  - Verification: Testing checklist, Regression check"
echo ""
echo "WORKFLOW:"
echo "  1. Fill 'Problem Description' section"
echo "  2. Investigate and document in 'Investigation' section"
echo "  3. Plan fix in 'Solution' section"
echo "  4. Implement fix"
echo "  5. Verify with 'Verification' checklist"
echo ""
echo "FEATURE_PHASE: INVESTIGATION"
echo "NEXT_ACTION: Fill about.md with bug details"
echo "========================================"
